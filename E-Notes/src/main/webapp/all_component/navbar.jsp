...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	<a class="navbar-brand" href="index.jsp"><i
		class="fas fa-journal-whills"></i> E-Notes </a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="addNotes.jsp"><i
					class="fas fa-plus-circle"></i> Add Notes </a></li>

			<li class="nav-item"><a class="nav-link" href="showNotes.jsp"><i
					class="fas fa-sticky-note"></i> Show Notes </a></li>
		</ul>
		...
		<a href="" class="btn btn-light my-2 my-sm-0 mr-2" type="submit"
			...
			type="submit"> <i class="fas fa-user-plus"></i> Logout
		</a>
